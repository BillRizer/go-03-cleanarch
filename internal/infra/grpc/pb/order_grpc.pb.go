...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *ListOrdersRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *ListOrdersRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *ListOrdersRequest) (*ListOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *ListOrdersRequest) (*ListOrdersResponse, error) {
...
func _OrderService_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrder(ctx, req.(*ListOrdersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
